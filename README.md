...
## TODO list
 ...
 - affichage des flags de toutes les équipes, en tenant compte du "flag public". Du coup, il faut changer la structure de la table "partial". Un enregistrement par (team, chal, flag_interm), avec horodatage (non c'est OK avec les awards).
